...
if __name__ == '__main__':
    ...
    import os
    os.chdir(r"C:\software_development\stem3\run_stem\stiff_files_dir_cg_no_av_5_rail_t5e4")

    parameter_file_names = ["ProjectParameters_stage_1.json", "ProjectParameters_stage_2.json"]
    model = Kratos.Model()
