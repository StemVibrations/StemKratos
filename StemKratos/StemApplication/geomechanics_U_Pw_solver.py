...
from StemKratos.StemApplication.geomechanics_newton_raphson_strategy import \
    StemGeoMechanicsNewtonRaphsonLinearElasticStrategy
...
class UPwUvecSolver(UPwGeoSolver):
    ...
    def _ConstructSolver(self, builder_and_solver, strategy_type):
        ...
        if strategy_type.lower() == "newton_raphson_with_uvec":
            ...
            solving_strategy = StemGeoMechanicsNewtonRaphsonLinearElasticStrategy(
