...
def test_call_uvec_multi_stage_noh_bathe():
    """
    Test the call of the UVEC in a multi-stage analysis, using the linear elastic solver.
    """
    test_file_dir = r"tests/test_data/input_data_multi_stage_uvec_noh_bathe"
    ...
    calculated_disp_file = Path(r"tests/test_data/input_data_multi_stage_uvec_noh_bathe/output/calculated_disp")
    expected_disp_file = Path(r"tests/test_data/input_data_multi_stage_uvec_noh_bathe/_output/expected_disp")
    ...
    expected_vtk_output_dir = Path("tests/test_data/input_data_multi_stage_uvec_noh_bathe/_output/all")

    main_vtk_output_dir = Path("tests/test_data/input_data_multi_stage_uvec_noh_bathe/output/porous_computational_model_part_1")
    stage_vtk_output_dir = Path("tests/test_data/input_data_multi_stage_uvec_noh_bathe/output/porous_computational_model_part_2")
    ...
    os.remove("tests/test_data/input_data_multi_stage_uvec_noh_bathe/set_moving_load_process_moving_load_cloned_1.rest")
    os.remove("tests/test_data/input_data_multi_stage_uvec_noh_bathe/set_moving_load_process_moving_load_cloned_2.rest")
